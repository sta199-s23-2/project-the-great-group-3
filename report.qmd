...
|           |                           |                                            |                               |                              |
|---------------|---------------|---------------|---------------|---------------|
| Data:     | [All Schools]{.underline} | [All Schools Outliers Removed]{.underline} | [Private Schools]{.underline} | [Public Schools]{.underline} |
| AIC:      | 7723.431                  | 7409.35                                    | 490.849                       | 869.687                      |
| R Square: | 0.008                     | 0.003                                      | 0.112                         | 0.082                        |

| Data | Col2 | Col3 | Col4 | Col5 |
|------|------|------|------|------|
|      |      |      |      |      |
|      |      |      |      |      |

Without filtering the data at all and not faceting the data by any groups, there is a 0.0028 correlation between the two variables. This shows that it is incredibly low positive correlation.
